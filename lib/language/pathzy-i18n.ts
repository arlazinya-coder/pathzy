...
const phase2Translations = {
  en: {
    ...
    "app.shell.tagline": "PATHZY is The Employment Support System. From Potential to Employment.",
    "app.shell.setupInProgress": "Setup in progress",
    ...
    "opportunities.eyebrow": "Jobs",
    "opportunities.title": "Opportunities for you",
    "opportunities.body": "PATHZY shows real provider listings only, then explains suitability and eligibility separately before you decide what to do next. PATHZY never substitutes fake vacancies.",
    "opportunities.tabs.recommended": "Recommended",
    "opportunities.tabs.near": "Near Reach",
    "opportunities.tabs.saved": "Saved",
    "opportunities.tabs.all": "All Jobs",
    "opportunities.match.strong": "Strong Match",
    "opportunities.match.good": "Good Match",
    "opportunities.match.possible": "Near Reach",
    "opportunities.match.stretch": "Not Recommended Yet",
    "opportunities.eligibility.compatible": "Compatible",
    "opportunities.eligibility.check": "Check needed",
    "opportunities.eligibility.blocked": "Blocked",
    "opportunities.eligibility.unknown": "Unknown",
    "opportunities.provider.connected": "Live jobs connected",
    "opportunities.provider.noMatches": "No live matches yet",
    "opportunities.provider.paused": "Live jobs paused",
    "opportunities.provider.unavailable": "Live jobs unavailable",
    "opportunities.provider.connectedMessage": "Live listings from",
    "opportunities.provider.noMatchesMessage": "No real vacancies were found for this search. Try a broader role or location.",
    "opportunities.provider.pausedMessage": "Live opportunities are temporarily unavailable. PATHZY will not show fake vacancies.",
    "opportunities.provider.unavailableMessage": "Live opportunities are temporarily unavailable. You can still inspect a job advert and prepare safely.",
    "opportunities.inspectAdvert": "Inspect a job advert",
    "opportunities.filters.aria": "Search and filter real job results",
    "opportunities.filters.keyword": "Role or keyword",
    "opportunities.filters.keywordPlaceholder": "Search title, skills or employer",
    "opportunities.filters.location": "Location",
    "opportunities.filters.locationPlaceholder": "City, province or remote",
    "opportunities.filters.search": "Search live jobs",
    "opportunities.filters.advanced": "Advanced filters",
    "opportunities.filters.hide": "Hide filters",
    "opportunities.filters.employmentType": "Employment type",
    "opportunities.filters.workMode": "Work mode",
    "opportunities.filters.salaryFrom": "Salary from",
    "opportunities.filters.salaryPlaceholder": "Minimum salary",
    "opportunities.filters.datePosted": "Date posted",
    "opportunities.filters.anyDate": "Any date",
    "opportunities.filters.last7": "Last 7 days",
    "opportunities.filters.last30": "Last 30 days",
    "opportunities.filters.seniority": "Seniority",
    "opportunities.filters.any": "Any",
    "opportunities.stats.saved": "Saved",
    "opportunities.stats.applied": "Applied",
    "opportunities.stats.done": "Done",
    "opportunities.stats.pipelinePrefix": "All Jobs shows",
    "opportunities.stats.pipelineMiddle": "real vacancies from",
    "opportunities.stats.pipelineSuffix": "normalized provider results.",
    "opportunities.stats.recommended": "Recommended",
    "opportunities.stats.nearReach": "Near Reach",
    "opportunities.progress.title": "Application progress",
    "opportunities.progress.empty": "No saved, applied or completed jobs yet. Start by inspecting or saving one real opportunity.",
    "opportunities.bestMatch": "Best Match",
    "opportunities.bestMatchFallback": "This role has the strongest confirmed fit in the current live results.",
    "opportunities.actions.view": "View Opportunity",
    "opportunities.actions.hide": "Hide details",
    "opportunities.actions.save": "Save",
    "opportunities.actions.saved": "Saved",
    "opportunities.actions.prepare": "Prepare My Application",
    "opportunities.actions.preparing": "Preparing...",
    "opportunities.actions.viewOriginal": "View original job",
    "opportunities.actions.markApplied": "Mark as Applied",
    "opportunities.actions.applied": "Applied",
    "opportunities.actions.track": "Track application",
    "opportunities.actions.notForMe": "Not for me",
    "opportunities.card.liveListing": "Live listing",
    "opportunities.card.eligibility": "Eligibility",
    "opportunities.card.posted": "Posted",
    "opportunities.card.closing": "Closing",
    "opportunities.card.unknown": "Unknown",
    "opportunities.card.why": "Why PATHZY recommends this",
    "opportunities.card.check": "What to check",
    "opportunities.card.noChecks": "No major check found from your confirmed profile.",
    "opportunities.detail.basics": "Job basics",
    "opportunities.detail.match": "PATHZY match",
    "opportunities.detail.matchBody": "PATHZY separates suitability from eligibility so you can choose a truthful next step.",
    "opportunities.detail.whyMatch": "Why you match",
    "opportunities.detail.partial": "Partial match",
    "opportunities.detail.missing": "Missing or unconfirmed",
    "opportunities.detail.responsibilities": "Responsibilities",
    "opportunities.detail.requirements": "Candidate requirements",
    "opportunities.detail.eligibility": "Eligibility",
    "opportunities.detail.beforeApply": "Before you apply",
    "opportunities.detail.confirmed": "Confirmed",
    "opportunities.detail.partialState": "Partial",
    "opportunities.detail.missingState": "Missing/Unconfirmed",
    "opportunities.detail.checkState": "Check",
    "opportunities.detail.advertState": "Job advert",
    "opportunities.detail.approvalState": "User approval required",
    "opportunities.detail.noMatchEvidence": "No confirmed match evidence yet.",
    "opportunities.detail.noPartial": "No partial match to strengthen right now.",
    "opportunities.detail.noUnknowns": "No major unknowns detected from this advert.",
    "opportunities.detail.reviewOriginal": "Review the original advert before sending anything.",
    "opportunities.detail.prepareTruthful": "Prepare a truthful CV and cover letter from your Professional Identity.",
    "opportunities.detail.noAutoApply": "PATHZY will not submit an application for you.",
    "opportunities.detail.originalPreserved": "Original source preserved",
    "opportunities.empty.providerUnavailable": "The job provider is unavailable right now. PATHZY will not show fake vacancies.",
    "opportunities.empty.invalidProvider": "The job provider returned a response PATHZY could not read. No fake vacancies are shown.",
    "opportunities.empty.noJobs": "No real jobs were found for this search. Try a broader role or location.",
    "opportunities.empty.default": "No visible opportunities in this tab. Save a job, broaden your search, or update your Professional Identity.",
    "opportunities.recommendationFallback.message": "We found opportunities for you, but PATHZY needs a little more information before recommending them with confidence.",
    "opportunities.recommendationFallback.location": "Add your location to improve your recommendations.",
    "opportunities.import.eyebrow": "Job Import",
    "opportunities.import.title": "Inspect a job advert",
    "opportunities.import.body": "Paste or upload a job advert. PATHZY will extract the job basics first, then you can review them before matching your profile in the next step.",
    "opportunities.import.languages": "English + French",
    "opportunities.import.method": "Job import method",
    "opportunities.import.paste": "Paste text",
    "opportunities.import.manual": "Manual entry",
    "opportunities.import.upload": "Upload file",
    "opportunities.import.link": "Job link",
    "opportunities.import.description": "Job description",
    "opportunities.import.descriptionPlaceholder": "Paste the full job description, responsibilities, requirements, closing date and application instructions.",
    "opportunities.import.titleField": "Job title",
    "opportunities.import.organisation": "Organisation",
    "opportunities.import.workArrangement": "Work arrangement",
    "opportunities.import.workPlaceholder": "Remote, hybrid, on-site",
    "opportunities.import.closingDate": "Closing date",
    "opportunities.import.uploadAdvert": "Upload job advert",
    "opportunities.import.uploadHelp": "PDF, DOCX and TXT can be inspected now. Image adverts may ask for pasted text until OCR is available.",
    "opportunities.import.publicUrl": "Public job advert link",
    "opportunities.import.noAuto": "PATHZY will not compare your profile or apply automatically in this step.",
    "opportunities.import.inspecting": "Inspecting job...",
    "opportunities.import.inspect": "Inspect Job",
    "opportunities.import.review": "Review imported job",
    "opportunities.import.titleNeedsReview": "Job title needs review",
    "opportunities.import.languageFrench": "French",
    "opportunities.import.languageEnglish": "English",
    "opportunities.import.languageReview": "Language needs review",
    "opportunities.import.warnings": "Warnings",
    "opportunities.import.noRequirements": "No clear requirements yet.",
    "opportunities.import.noResponsibilities": "No clear responsibilities yet.",
    "opportunities.import.noWarnings": "No warning detected.",
    "opportunities.import.savedForMatching": "Saved for Matching",
    "opportunities.import.saveReview": "Save Job Review",
    "opportunities.import.matchingNext": "Profile matching comes next.",
    "opportunities.analysis.eyebrow": "Job Analysis",
    "opportunities.analysis.title": "Review the job analysis",
    "opportunities.analysis.body": "PATHZY has not matched this job to your profile yet. First, confirm what the job asks for so the next step stays truthful.",
    "opportunities.analysis.confidence": "Confidence",
    "opportunities.analysis.create": "Review Analysis",
    "opportunities.analysis.creating": "Analysing job...",
    "opportunities.analysis.creates": "This creates responsibilities, requirements, evidence and application details.",
    "opportunities.analysis.summary": "Summary",
    "opportunities.analysis.addRequirement": "Add requirement",
    "opportunities.analysis.evidence": "Evidence",
    "opportunities.analysis.remove": "Remove",
    "opportunities.analysis.noResponsibilities": "No responsibilities extracted. Add them in the source import review before matching.",
    "opportunities.analysis.noRequirements": "No requirements extracted. Add them before matching.",
    "opportunities.analysis.originalSaved": "Original source references are saved for review. PATHZY stores evidence, not hidden reasoning.",
    "opportunities.analysis.confirmed": "Analysis Confirmed",
    "opportunities.analysis.confirm": "Confirm Job Analysis",
    "opportunities.analysis.importance": "Importance",
    "opportunities.analysis.type": "Type",
    "opportunities.analysis.mandatory": "Mandatory",
    "opportunities.analysis.preferred": "Preferred",
    "opportunities.analysis.optional": "Optional",
    "opportunities.analysis.unclear": "Unclear",
    "opportunities.analysis.applicationDetails": "Application Details",
    "opportunities.analysis.applicationMethod": "Application method",
    "opportunities.analysis.contactEmail": "Contact email",
    "opportunities.analysis.referenceNumber": "Reference number",
    "opportunities.analysis.noPhase8B": "No match score is created in Phase 8B."
  },
  fr: {
    ...
    "public.footer.contact": "Contact",
    "public.footer.disclaimer": "Avertissement",
    "app.shell.tagline": "PATHZY est le système d'accompagnement vers l'emploi. Du potentiel à l'emploi.",
    "app.shell.setupInProgress": "Configuration en cours",
    ...
    "opportunities.eyebrow": "Emplois",
    "opportunities.title": "Opportunités pour vous",
    "opportunities.body": "PATHZY affiche uniquement de vraies offres provenant de fournisseurs, puis explique séparément l'adéquation et l'éligibilité avant que vous décidiez de la suite. PATHZY ne remplace jamais les offres par de fausses annonces.",
    "opportunities.tabs.recommended": "Recommandées",
    "opportunities.tabs.near": "À portée",
    "opportunities.tabs.saved": "Enregistrées",
    "opportunities.tabs.all": "Tous les emplois",
    "opportunities.match.strong": "Correspondance forte",
    "opportunities.match.good": "Bonne correspondance",
    "opportunities.match.possible": "À portée",
    "opportunities.match.stretch": "Pas encore recommandé",
    "opportunities.eligibility.compatible": "Compatible",
    "opportunities.eligibility.check": "À vérifier",
    "opportunities.eligibility.blocked": "Bloqué",
    "opportunities.eligibility.unknown": "Inconnu",
    "opportunities.provider.connected": "Emplois en direct connectés",
    "opportunities.provider.noMatches": "Aucune correspondance en direct pour le moment",
    "opportunities.provider.paused": "Emplois en direct en pause",
    "opportunities.provider.unavailable": "Emplois en direct indisponibles",
    "opportunities.provider.connectedMessage": "Offres en direct depuis",
    "opportunities.provider.noMatchesMessage": "Aucune vraie offre n'a été trouvée pour cette recherche. Essayez un rôle ou un lieu plus large.",
    "opportunities.provider.pausedMessage": "Les opportunités en direct sont temporairement indisponibles. PATHZY n'affichera pas de fausses offres.",
    "opportunities.provider.unavailableMessage": "Les opportunités en direct sont temporairement indisponibles. Vous pouvez toujours analyser une annonce et vous préparer en sécurité.",
    "opportunities.inspectAdvert": "Analyser une annonce",
    "opportunities.filters.aria": "Rechercher et filtrer les vrais résultats d'emploi",
    "opportunities.filters.keyword": "Rôle ou mot-clé",
    "opportunities.filters.keywordPlaceholder": "Rechercher un titre, une compétence ou un employeur",
    "opportunities.filters.location": "Lieu",
    "opportunities.filters.locationPlaceholder": "Ville, province ou télétravail",
    "opportunities.filters.search": "Rechercher des emplois en direct",
    "opportunities.filters.advanced": "Filtres avancés",
    "opportunities.filters.hide": "Masquer les filtres",
    "opportunities.filters.employmentType": "Type d'emploi",
    "opportunities.filters.workMode": "Mode de travail",
    "opportunities.filters.salaryFrom": "Salaire à partir de",
    "opportunities.filters.salaryPlaceholder": "Salaire minimum",
    "opportunities.filters.datePosted": "Date de publication",
    "opportunities.filters.anyDate": "Toute date",
    "opportunities.filters.last7": "7 derniers jours",
    "opportunities.filters.last30": "30 derniers jours",
    "opportunities.filters.seniority": "Niveau",
    "opportunities.filters.any": "Tous",
    "opportunities.stats.saved": "Enregistrées",
    "opportunities.stats.applied": "Envoyées",
    "opportunities.stats.done": "Terminées",
    "opportunities.stats.pipelinePrefix": "Tous les emplois affiche",
    "opportunities.stats.pipelineMiddle": "vraies offres depuis",
    "opportunities.stats.pipelineSuffix": "résultats fournisseur normalisés.",
    "opportunities.stats.recommended": "Recommandées",
    "opportunities.stats.nearReach": "À portée",
    "opportunities.progress.title": "Progression des candidatures",
    "opportunities.progress.empty": "Aucun emploi enregistré, envoyé ou terminé pour le moment. Commencez par analyser ou enregistrer une vraie opportunité.",
    "opportunities.bestMatch": "Meilleure correspondance",
    "opportunities.bestMatchFallback": "Ce rôle présente la meilleure adéquation confirmée parmi les résultats en direct actuels.",
    "opportunities.actions.view": "Voir l'opportunité",
    "opportunities.actions.hide": "Masquer les détails",
    "opportunities.actions.save": "Enregistrer",
    "opportunities.actions.saved": "Enregistrée",
    "opportunities.actions.prepare": "Préparer ma candidature",
    "opportunities.actions.preparing": "Préparation...",
    "opportunities.actions.viewOriginal": "Voir l'annonce originale",
    "opportunities.actions.markApplied": "Marquer comme envoyée",
    "opportunities.actions.applied": "Envoyée",
    "opportunities.actions.track": "Suivre la candidature",
    "opportunities.actions.notForMe": "Pas pour moi",
    "opportunities.card.liveListing": "Annonce en direct",
    "opportunities.card.eligibility": "Éligibilité",
    "opportunities.card.posted": "Publié",
    "opportunities.card.closing": "Clôture",
    "opportunities.card.unknown": "Inconnu",
    "opportunities.card.why": "Pourquoi PATHZY recommande cela",
    "opportunities.card.check": "À vérifier",
    "opportunities.card.noChecks": "Aucun point majeur à vérifier à partir de votre profil confirmé.",
    "opportunities.detail.basics": "Informations de l'emploi",
    "opportunities.detail.match": "Correspondance PATHZY",
    "opportunities.detail.matchBody": "PATHZY sépare l'adéquation et l'éligibilité pour vous aider à choisir une prochaine étape honnête.",
    "opportunities.detail.whyMatch": "Pourquoi vous correspondez",
    "opportunities.detail.partial": "Correspondance partielle",
    "opportunities.detail.missing": "Manquant ou non confirmé",
    "opportunities.detail.responsibilities": "Responsabilités",
    "opportunities.detail.requirements": "Exigences candidat",
    "opportunities.detail.eligibility": "Éligibilité",
    "opportunities.detail.beforeApply": "Avant de postuler",
    "opportunities.detail.confirmed": "Confirmé",
    "opportunities.detail.partialState": "Partiel",
    "opportunities.detail.missingState": "Manquant/non confirmé",
    "opportunities.detail.checkState": "À vérifier",
    "opportunities.detail.advertState": "Annonce",
    "opportunities.detail.approvalState": "Validation utilisateur requise",
    "opportunities.detail.noMatchEvidence": "Aucune preuve de correspondance confirmée pour le moment.",
    "opportunities.detail.noPartial": "Aucune correspondance partielle à renforcer pour le moment.",
    "opportunities.detail.noUnknowns": "Aucune inconnue majeure détectée dans cette annonce.",
    "opportunities.detail.reviewOriginal": "Vérifiez l'annonce originale avant d'envoyer quoi que ce soit.",
    "opportunities.detail.prepareTruthful": "Préparez un CV et une lettre honnêtes à partir de votre Identité Professionnelle.",
    "opportunities.detail.noAutoApply": "PATHZY n'enverra pas de candidature pour vous.",
    "opportunities.detail.originalPreserved": "Source originale conservée",
    "opportunities.empty.providerUnavailable": "Le fournisseur d'emplois est indisponible pour le moment. PATHZY n'affichera pas de fausses offres.",
    "opportunities.empty.invalidProvider": "Le fournisseur d'emplois a renvoyé une réponse que PATHZY ne peut pas lire. Aucune fausse offre n'est affichée.",
    "opportunities.empty.noJobs": "Aucun vrai emploi n'a été trouvé pour cette recherche. Essayez un rôle ou un lieu plus large.",
    "opportunities.empty.default": "Aucune opportunité visible dans cet onglet. Enregistrez un emploi, élargissez votre recherche ou mettez à jour votre Identité Professionnelle.",
    "opportunities.recommendationFallback.message": "Nous avons trouvé des opportunités pour vous, mais PATHZY a besoin d'un peu plus d'informations avant de les recommander avec confiance.",
    "opportunities.recommendationFallback.location": "Ajoutez votre lieu pour améliorer vos recommandations.",
    "opportunities.import.eyebrow": "Import d'emploi",
    "opportunities.import.title": "Analyser une annonce",
    "opportunities.import.body": "Collez ou téléversez une annonce. PATHZY extrait d'abord les informations essentielles, puis vous les vérifiez avant le matching avec votre profil.",
    "opportunities.import.languages": "Anglais + français",
    "opportunities.import.method": "Méthode d'import d'emploi",
    "opportunities.import.paste": "Coller le texte",
    "opportunities.import.manual": "Saisie manuelle",
    "opportunities.import.upload": "Téléverser un fichier",
    "opportunities.import.link": "Lien de l'emploi",
    "opportunities.import.description": "Description du poste",
    "opportunities.import.descriptionPlaceholder": "Collez la description complète, les responsabilités, exigences, date de clôture et consignes de candidature.",
    "opportunities.import.titleField": "Titre du poste",
    "opportunities.import.organisation": "Organisation",
    "opportunities.import.workArrangement": "Mode de travail",
    "opportunities.import.workPlaceholder": "À distance, hybride, sur site",
    "opportunities.import.closingDate": "Date de clôture",
    "opportunities.import.uploadAdvert": "Téléverser une annonce",
    "opportunities.import.uploadHelp": "PDF, DOCX et TXT peuvent être analysés maintenant. Les annonces image peuvent demander du texte collé jusqu'à disponibilité de l'OCR.",
    "opportunities.import.publicUrl": "Lien public de l'annonce",
    "opportunities.import.noAuto": "PATHZY ne comparera pas votre profil et ne postulera pas automatiquement à cette étape.",
    "opportunities.import.inspecting": "Analyse en cours...",
    "opportunities.import.inspect": "Analyser l'emploi",
    "opportunities.import.review": "Vérifier l'emploi importé",
    "opportunities.import.titleNeedsReview": "Le titre du poste doit être vérifié",
    "opportunities.import.languageFrench": "Français",
    "opportunities.import.languageEnglish": "Anglais",
    "opportunities.import.languageReview": "Langue à vérifier",
    "opportunities.import.warnings": "Alertes",
    "opportunities.import.noRequirements": "Aucune exigence claire pour le moment.",
    "opportunities.import.noResponsibilities": "Aucune responsabilité claire pour le moment.",
    "opportunities.import.noWarnings": "Aucune alerte détectée.",
    "opportunities.import.savedForMatching": "Enregistré pour le matching",
    "opportunities.import.saveReview": "Enregistrer la vérification",
    "opportunities.import.matchingNext": "Le matching du profil vient ensuite.",
    "opportunities.analysis.eyebrow": "Analyse de l'emploi",
    "opportunities.analysis.title": "Vérifier l'analyse de l'emploi",
    "opportunities.analysis.body": "PATHZY n'a pas encore comparé cet emploi à votre profil. Confirmez d'abord ce que l'emploi demande pour garder la suite honnête.",
    "opportunities.analysis.confidence": "Confiance",
    "opportunities.analysis.create": "Vérifier l'analyse",
    "opportunities.analysis.creating": "Analyse de l'emploi...",
    "opportunities.analysis.creates": "Cela crée les responsabilités, exigences, preuves et détails de candidature.",
    "opportunities.analysis.summary": "Résumé",
    "opportunities.analysis.addRequirement": "Ajouter une exigence",
    "opportunities.analysis.evidence": "Preuve",
    "opportunities.analysis.remove": "Supprimer",
    "opportunities.analysis.noResponsibilities": "Aucune responsabilité extraite. Ajoutez-les dans la vérification de l'import avant le matching.",
    "opportunities.analysis.noRequirements": "Aucune exigence extraite. Ajoutez-les avant le matching.",
    "opportunities.analysis.originalSaved": "Les références de source originale sont conservées pour vérification. PATHZY stocke les preuves, pas un raisonnement caché.",
    "opportunities.analysis.confirmed": "Analyse confirmée",
    "opportunities.analysis.confirm": "Confirmer l'analyse de l'emploi",
    "opportunities.analysis.importance": "Importance",
    "opportunities.analysis.type": "Type",
    "opportunities.analysis.mandatory": "Obligatoire",
    "opportunities.analysis.preferred": "Préféré",
    "opportunities.analysis.optional": "Facultatif",
    "opportunities.analysis.unclear": "À clarifier",
    "opportunities.analysis.applicationDetails": "Détails de candidature",
    "opportunities.analysis.applicationMethod": "Méthode de candidature",
    "opportunities.analysis.contactEmail": "E-mail de contact",
    "opportunities.analysis.referenceNumber": "Numéro de référence",
    "opportunities.analysis.noPhase8B": "Aucun score de correspondance n'est créé en Phase 8B."
  }
} as const;
