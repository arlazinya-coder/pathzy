      ...
      <Card>
        <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-black text-white">{language === "fr" ? "Actions secondaires" : "Secondary actions"}</h2>
            <p className="mt-3 text-sm font-bold leading-6 text-white/64">{language === "fr" ? "Jusqu'à trois actions utiles, dans l'ordre PATHZY." : "Up to three useful actions, in PATHZY order."}</p>
          </div>
